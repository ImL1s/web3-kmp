...
class BubblegumIntegTest {
    ...
    companion object {
        ...
        suspend fun signer(): HotSigner {
            ...
            return HotSigner(SolanaKeypair(PublicKey(k.publicKey.bytes), k.secretKey))
        }
    }
    ...
    fun testCreateTree() = runTest {
        ...
        val merkleTree = HotSigner(SolanaKeypair(PublicKey(merkleTreeKeypair.publicKey.bytes), merkleTreeKeypair.secretKey))
        ...
        val tree = SolanaTransactionBuilder()
            ...
            .addInstruction(
                BubblegumInstructions.createTree(
                    ...
                    PublicKey(merkleTree.publicKey.bytes),
