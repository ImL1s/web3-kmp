    ...
    fun `extra script tests`() {
        ...
        val tests = json.parseToJsonElement(
           ...
           [
            ...
            ["$longScript", "ADD 20 EQUAL", "P2SH,STRICTENC", "TOO_MANY_OPS"],
            ["$longScript", "ADD 20 EQUAL", "P2SH,STRICTENC", "TOO_MANY_OPS"],
    ...
    companion object {
        ...
        private fun runTest(
            ...
            val result = try {
                ...
                // println("Script failed with error: ${t.message}")
                false
            }
            try {
                ...
                println("Test failed:")
                println("  Witness: $witnessText")
                println("  ScriptSig: $scriptSigText")
                println("  ScriptPubKey: $scriptPubKeyText")
                println("  Flags: $flags")
